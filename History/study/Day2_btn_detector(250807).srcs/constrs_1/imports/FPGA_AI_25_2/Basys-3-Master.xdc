...
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports brnL_Clear]
#set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports brnR_RunStop]
