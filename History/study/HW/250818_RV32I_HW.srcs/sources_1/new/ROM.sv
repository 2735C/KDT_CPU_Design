...
module ROM (  // 명령어가 저장되어 있는 곳
    ...
    initial begin
        ...
        rom[7] = 32'b000000000100_00010_111_01010_0010011;  //andi x10, x2, 4 -> 4
        rom[8] = 32'b000000000001_00010_110_01011_0010011;  //ori x11, x2, 1 -> 13
        //rom [x] = 32'b imm12 _ rs1(5) _ f3_ rd _ op(7) // I-type: Shift
        rom[9]  = 32'b000000001000_00001_001_01100_0010011;  //SLLi x12, x1, 8 -> 13
        rom[10] = 32'b000000000010_00010_101_01101_0010011;  //SRLi x13, x2, 2 -> 13
        rom[11] = 32'b010000000010_00010_101_01110_0010011;  //SRAi x14, x2, 2 -> 13
    end
