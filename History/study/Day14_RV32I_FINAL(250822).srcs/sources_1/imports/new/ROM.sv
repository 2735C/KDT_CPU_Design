...
module ROM (
    ...
    rom[22] = 32'b0000000_01110_00000_000_01000_0100011; // SB x14  x0  16 => -128
    ...
    // L Type
    // rom[x] =      imm(12)    rs1   f3   rd  opcode           rd  rs1 imm
    rom[25] = 32'b000000001000_00000_000_00100_0000011; // LB   x4  x0  16  => regFile[8] = -128
    ...
    rom[28] = 32'b000000001000_00000_100_00111_0000011; // LBU  x7  x0  16 => regFile[8] = 128
